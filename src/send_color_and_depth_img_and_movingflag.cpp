...
public:
...
#endif
    _sub3 = _nh.subscribe ("/mobile_base/commands/velocity", 1,  &ViewImage::vel_cb, this);
    ROS_INFO ("Listening for incoming data on topic /mobile_base/commands/velocity ..." );
  ...
  //* get moving flag
  void vel_cb( const geometry_msgs::TwistConstPtr& msg ){
    // std::cout << msg->linear.x << " ";
    // std::cout << msg->linear.y << " ";
    // std::cout << msg->linear.z << " | ";
    // std::cout << msg->angular.x << " ";
    // std::cout << msg->angular.y << " ";
    // std::cout << msg->angular.z << std::endl;
    if( (msg->linear.x!=0) || (msg->linear.y!=0) || (msg->linear.z!=0) || (msg->angular.x!=0) || (msg->angular.y!=0) || (msg->angular.z!=0) )
      moving_flg = true;
    else
      moving_flg = false;
    if (moving_flg)
  ...
  void image_cb( const sensor_msgs::ImageConstPtr& msg ){
    ...
    buffer[ MY_BUFFER_SIZE - 1 ] = (char)moving_flg;
    msc.send( buffer );
  }
